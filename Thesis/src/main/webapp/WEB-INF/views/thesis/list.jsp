...
<div class="jq-layout rel" data-options="fit:true">
	<div data-options="region:'north',border:false">
        <div id="grid-toolbar" class="clearfix p5">
	        ...
	        <select class="jq-combobox" id="majorlistwhere" name="majorOneId" style="width:100px" data-options="{
						required:true,
						method:'post',
						editable:false,
...
// 		alert(majorId);
		$("#thesisList").datagrid({
			url:'${z:u("/thesis/list")}?thesisName='+thesisName+"&thesisCode="+thesisCode+"&timeStart="+timeStart+"&timeEnd="+timeEnd+"&status="+status+"&collegeId="+collegeId+"&majorId="+majorId
		});
	});
