...
<!--             <a id="download" class="btn btn-sm btn-info"><i class="icon icon-edit"></i>下载论文</a>  -->
	...
	<div data-options="region:'center',border:false">
		<table class="jq-datagrid" fit="true" id="receivelist" data-options="{
			url: '${z:u('thesis/list_receive_oto')}',
			method:'post',
			...
			columns: [[
				...
				{field:'teacherId',title:'接审人',width:100 ,sortable:'true'},
...
// 		var areaId = $("#arealist").combobox("getValue");
    	...
    	$("#receivelist").datagrid({
			url:'${z:u("/thesis/list_receive")}?'+"&universityId="+universityId+"&thesisCode="+thesisCode+"&thesisName="+thesisName+"&timeStart="+timeStart+"&timeEnd="+timeEnd+"&status="+status
		});
	});
