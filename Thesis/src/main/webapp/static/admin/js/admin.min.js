var LoadingMask, LoadingMsg, loading = {
    addMsk: function(t) {
        ...
        LoadingMsg = $('<div class="datagrid-mask-msg"></div>').html(t).appendTo("body").css({
            display: "block",
            "z-index": "100000",
...
App = function() {
    ...
    r = function() {
        $.ajaxSetup({
            complete: function(t, e) {
                ...
                "-1" == a && $.messager.alert("提示", "登录超时，请重新登录!", "warning",
                function() {
            ...
            function() {
                ...
                a != $("#nav-menu li.active").index() ? $(".main-menu:first .sub-menu li:first").click() : (n.indexOf("?") > -1 && (n = n.split("?")[0]), $(".main-menu .sub-menu li").each(function() {
                    if (n == $(this).data("hash")) {
                        ...
                        return t.hasClass("accordion-header-selected") || t.click(),
                        $(this).click(),
                        !1
                    }
                }))
    ...
    o = function() {
        $("#left").delegate(".main-menu .sub-menu li", "click",
        function(t) {
    ...
    l = function() { (a || n) && $("input[placeholder]:not(.placeholder-no-fix), textarea[placeholder]:not(.placeholder-no-fix)").each(function() {
            var t = $(this);
            "" == t.val() && "" != t.attr("placeholder") && t.addClass("placeholder").val(t.attr("placeholder")),
            t.focus(function() {
                t.val() == t.attr("placeholder") && t.val("")
            }),
            t.blur(function() { ("" == t.val() || t.val() == t.attr("placeholder")) && t.val(t.attr("placeholder"))
            })
        })
    },
    u = function(t, e) {
        if (e) $("#crumb .c4").html("/ " + e),
        $("#content").load(t,
        function() {
            $.parser && $.parser.parse("#content")
        });
    ...
    c = function(t) {
        ...
        } else $(".jq-datagrid").datagrid("reload"),
    ...
    g = function(e, a) {
        ...
        $(e).form({
            ...
            success: function(t) {
                ...
                $(e).find("button[type='submit']").removeAttr("disabled", "disabled").text(n),
                r && r(t),
                m(t, a)
            }
        }),
    ...
    f = function(e, a, n) {
        ...
        if ("object" == typeof arguments[1]) var r = $.extend({},
        i, arguments[1]),
        a = r.title,
        n = r.onLoad;
        else var r = $.extend({},
        ...
        t = $.dialog({
            ...
            onLoad: function() {
                var a = $(s).attr("action");
                a || $(s).attr("action", e),
                m && $(s).append("<input type='hidden' name='id' value='" + m + "' />"),
                g({
                    formId: s,
                    gridId: o,
                    success: function() {
    ...
    p = function(t, e) {
        ...
        if ("object" == typeof arguments[1]) var n = $.extend({},
        a, arguments[1]),
        e = n.msg,
        i = n.success,
        r = n.ok;
    ...
    w = function(t) {
        var e;
        return 0 == t ? e = "icon-cancel": 1 == t && (e = "icon-accept"),
        '<i class="icon ' + e + '"></i>'
    },
    x = function(t) {
        var e = new RegExp("(^|&)" + t + "=([^&]*)(&|$)"),
...
function() {
    App.dialog = $.dialog = function(t) {
        ...
        return t.href ? (loading.addMsk(), $.get(t.href,
        function(e) {
            LoadingMask && loading.removeMsk(),
            t.href = null,
            a.dialog(t);
            var n = a.find("div.dialog-content");
            n.html($.fn.panel.defaults.extractor(e)),
            a.dialog(t),
            $.parser && $.parser.parse(n),
            t.onLoad && t.onLoad.call(a)
        },
        "html")) : a.dialog(t),
        a
    },
